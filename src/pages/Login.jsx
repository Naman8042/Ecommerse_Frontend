    ...
    <div className='h-screen '>
      ...
      </div>
      {
        ...
        <div className='sm:w-[40%] w-full  flex sm:gap-4 gap-3  flex-col items-center justify-center h-full '>
           ...
           <input type='text' placeholder='Email or Phone Number' className='sm:w-[50%] w-[85%] sm:p-[1%] outline-none border-gray-400 sm:border-b-2 border-2 rounded-lg p-[2%]'/>  
           <input type='password' placeholder='Password' className='sm:w-[50%] w-[85%] sm:p-[1%] outline-none border-gray-400 sm:border-b-2 border-2 rounded-lg p-[2%]'/>  
           <button onClick={Login} className='bg-red-500 text-white w-[50%] py-[1.5%] rounded-md'>Login Account</button>
        ...
        <div className='w-full sm:w-[40%] flex sm:gap-4 gap-2 flex-col items-center justify-center h-full '>
           ...
           <p className='text-bg  w-[50%] mb-[1%] hidden sm:block'>Enter Your Details Here</p>
